...
builder.Services.AddSession(options =>
{
    ...
    // SameSite=None + Secure potrebno kada su frontend i backend na različitim domenama
    // (netlify.app i onrender.com). Bez ovoga browser blokira slanje session cookie-a.
