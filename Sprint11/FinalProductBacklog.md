...
## 📌 Napomena o završnom sprintu

U okviru završnog sprinta, tim je izvršio usklađivanje i reviziju svih preostalih stavki Product Backloga u skladu sa feedbackom i zahtjevima definisanim u dokumentu za završni sprint od strane asistenta.

Iako je inicijalni plan predviđao ukupno 13 sprintova, tokom realizacije projekta je utvrđeno da je Sprint 11 finalni sprint isporuke, te je tim prilagodio plan i fokusirao se na kompletiranje svih preostalih aktivnosti u okviru tog sprinta.

Kao rezultat toga:
* Sve preostale stavke Product Backloga su usklađene sa završnim zahtjevima.
* Sve funkcionalnosti i tehnički zadaci su uspješno implementirani ili finalizirani.
* Sistem je doveden u stanje spremno za finalnu demonstraciju i predaju.
* Backlog je u potpunosti zatvoren sa aspekta implementacije (uz izuzetak dokumentacionih finalizacija gdje je primjenjivo).

### 📊 Pregled statusa po stavkama
...
Planirali smo, ali nismo završili proširene filtere u izvještaju o učinku poštara (PBI-050). Osnovni izvještaj postoji, ali napredni parametri filtriranja nisu implementirani. 
...
| PBI-039 | Izraditi Team Charter | Definisati članove tima, kanale komunikacije, radna pravila i odgovornosti. | documentation | High | 2h | Done | Sprint 1 | Obavezan dokument |
...
| PBI-006 | Razraditi prioritetne user storyje | Definisati najvažnije user storyje za osnovne MVP funkcionalnosti. | documentation | High | 4h 30min | Done | Sprint 2 |  |
| PBI-007 | Definisati acceptance criteria | Napisati mjerljive i provjerljive acceptance kriterije za prioritetne storyje. | documentation | High | 4h | Done | Sprint 2 |  |
| PBI-008 | Uraditi prioritizaciju backloga | Razvrstati stavke po poslovnoj vrijednosti, zavisnostima i značaju za MVP. | research | High | 2h | Done | Sprint 2 |  |
| PBI-009 | Definisati početne NFR zahtjeve | Identifikovati početne nefunkcionalne zahtjeve poput sigurnosti, upotrebljivosti i pouzdanosti. | documentation | Medium | 3h | Done | Sprint 2 |  |
| PBI-031 | Izraditi početni Risk Register | Identifikovati glavne projektne, tehničke i operativne rizike sistema, procijeniti njihov uticaj i vjerovatnoću, te definisati početne mjere mitigacije. | documentation | High | 3h 30min | Done | Sprint 3 |  |
| PBI-033 | Izraditi Domain Model i/ili Use Case Model | Dokumentovati model domene i/ili ključne use-case scenarije na osnovu prethodno razrađenih zahtjeva i korisničkih uloga. | documentation | High | 4h | Done | Sprint 3 |  |
| PBI-034 | Definisati Architecture Overview | Pripremiti početni pregled arhitekture sistema, glavnih komponenti, njihovih odgovornosti i osnovnog toka podataka. | documentation | High | 3h 30min | Done | Sprint 3 | Osnovni arhitektonski pravac |
| PBI-035 | Definisati Test Strategy | Odrediti ciljeve testiranja, nivoe testiranja, vezu sa acceptance kriterijima i način evidentiranja rezultata testiranja. | documentation | High | 3h | Done | Sprint 3 |  |
...
| PBI-022 | Generisanje dnevne rute | Omogućiti administratoru ili dispečeru automatsko generisanje dnevne rute za odabranog poštara. | feature | High | 8h | Done | Sprint 8 | Osnovna optimizacija |
| PBI-023 | Dodjela rute poštaru | Omogućiti dispečeru da dodijeli generisanu rutu konkretnom poštaru. | feature | High | 3h | Done | Sprint 8 |  |
...
| PBI-050 | Prošireno operativno izvještavanje | Omogućiti generisanje izvještaja po poštaru, periodu i tipu sandučića, ne samo dnevni pregled. | feature | Medium | 4h | Partially Done | Sprint 11 | Nadogradnja PBI-030 |
...
| PBI-052 | Stabilizacija sistema i regresijsko testiranje | Provesti regresijsko testiranje svih ključnih funkcionalnosti i otkloniti pronađene greške. | technical | High | 8h | Done | Sprint 11 |  |
| PBI-053 | Finalni inkrement i "bug fixing" | Provesti završne korekcije koda, UI detalja i rubnih scenarija na osnovu feedbacka iz Sprinta 11. | technical | High | 6h | Done | Sprint 12 | Finalni kandidat za demonstraciju |
| PBI-054 | Release Notes | Pripremiti Release Notes koji opisuju šta sistem radi, koje su poznate limitacije i šta je isporučeno u finalnoj verziji. | documentation | High | 2h | Done | Sprint 11 | |
| PBI-055 | Korisnička dokumentacija | Pripremiti korisničku dokumentaciju s opisom sistema, korisničkih uloga i osnovnog načina korištenja. | documentation | High | 4h | Done | Sprint 11 |  |
| PBI-056 | Tehnička dokumentacija | Pripremiti tehničku dokumentaciju s pregledom arhitekture, glavnih komponenti, logike sistema i napomenama za pokretanje. | documentation | High | 4h | Done | Sprint 11 |  |
| PBI-057 | Ažuriranje svih logova i artefakata | Osigurati da su Product Backlog, Decision Log, AI Usage Log i svi ostali obavezni artefakti potpuni i ažurni za finalnu predaju. | documentation | High | 2h | Done | Sprint 11 | Kompletnost predaje |
| PBI-060 | Završni refleksivni izvještaj tima | Tim zajedno priprema izvještaj koji sumira razvoj projekta, ključne odluke, izazove i naučene lekcije  | documentation | High | 3h | Done | Sprint 11 | Obavezan deliverable |
| PBI-061 | Završna demonstracija | Isporučen gotov sistem i prezentacija | documentation | High | 4h | Done | Sprint 11 | Obavezan deliverable |
| PBI-052 | Upravljanje problematičnim lokacijama | Omogućiti pregled, komentarisanje, dodjelu akcija i praćenje statusa problematičnih lokacija nastalih tokom izvršavanja ruta. | feature | Medium | 5h | Done | Sprint 10 | Upravljanje incidentima i koordinacija između dispečera i poštara |
