...
|---|---|---|---|---|---|
| PBI-026 / US-26 | Mobilni prikaz dodijeljene rute | Rubina, Nejla | 5h 30min | To Do | Responzivni web prikaz rute za poštara; hronološka lista sandučića, interaktivna mapa, status badge za svaki sandučić, zaštita pristupa po ulozi |
| PBI-027 / US-27 | Ažuriranje statusa sandučića | Ibrahim, Emrah | 4h | To Do | Dugmad za promjenu statusa (Obrađen, Napunjen, Ispraznjen) unutar mobilnog prikaza, evidentiranje timestampa i autora, real-time ažuriranje |
...
| PBI-029 / US-29 | Praćenje statusa rute od strane dispečera | Kerim, Aldin | 5h | To Do | Dashboard za dispečera s real-time pregledom statusa po ruti i sandučiću, filtri po statusu, naglašavanje problematičnih lokacija |
| PBI-030 / US-30 | Osnovni dnevni izvještaj | Nejla, Ibrahim | 4h | To Do | Generisanje izvještaja za odabrani datum i poštara; agregacija obrađenih, preskočenih i nedostupnih sandučića, export u PDF |
